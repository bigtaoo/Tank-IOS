...
IL_003f:
	{
		...
		L_15 = DataTableCollection_get_Item_m993165A16E4DEDAF77DB419495AC48EC357903CE(L_12, ((String_t*)CastclassSealed((RuntimeObject*)L_14, il2cpp_defaults.string_class)), NULL);
		V_2 = L_15;
...
IL_00f4:
	...
	}
	{
		...
		NullCheck(L_56);
		Type_t* L_57;
		L_57 = VirtualFuncInvoker0< Type_t* >::Invoke(189, L_56);
...
IL_007d:
	{
		...
		NullCheck(L_13);
		Type_t* L_14;
		L_14 = VirtualFuncInvoker0< Type_t* >::Invoke(240, L_13);
		return L_14;
	}
...
IL_019a:
	{
		...
		NullCheck(L_89);
		Type_t* L_90;
		L_90 = VirtualFuncInvoker0< Type_t* >::Invoke(66, L_89);
...
IL_0014:
	{
		...
		L_5 = VirtualFuncInvoker1< ObjectU5BU5D_t8061030B0A12A55D5AD8652A20C922FE99450918*, bool >::Invoke(29, L_4, (bool)1);
		V_0 = (bool)0;
		V_1 = L_5;
		V_2 = 0;
		goto IL_0050;
...
IL_009f:
	{
		...
		NullCheck(L_28);
		String_t* L_29;
		L_29 = VirtualFuncInvoker0< String_t* >::Invoke(170, L_28);
		G_B14_0 = L_29;
		G_B14_1 = G_B13_0;
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR ReflectionObject_tBC7C0875C7434F4B89AC4948A4ECBD5CF84AE2E7* KeyValuePairConverter_InitializeReflectionObject_mECD1547C1FDDAE2A63C8FE1C2B2E45AE555B16F3 (Type_t* ___0_t, const RuntimeMethod* method) 
{
	...
	Type_t* V_1 = NULL;
	{
		...
		L_1 = VirtualFuncInvoker0< TypeU5BU5D_t97234E1129B564EB38B8D85CAC2AD8B5B9522FFB* >::Invoke(193, L_0);
